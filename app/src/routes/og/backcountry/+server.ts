...
export const GET: RequestHandler = async ({url, locals}) => {
    ...
    if(data){
        const {display_name, snow_past_7d, snow_past_24h, snow_next_24h, snow_next_72h, overall_danger_level} = data
        // @ts-ignore
        const result = BackcountryReportSocialCard.render({mountainName: display_name, snowLast7Days: snow_past_7d, snowLast24Hrs: snow_past_24h, snowNext24Hrs: snow_next_24h, snowNext72Hrs: snow_next_72h, avalancheDangerLevel: overall_danger_level});
