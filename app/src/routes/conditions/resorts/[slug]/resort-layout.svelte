<script lang="ts">
	...
	import { Area, Axis, Bars, Chart, ChartClipPath, Highlight, LinearGradient, RectClipPath, Spline, Svg, Tooltip, TooltipItem } from "layerchart";
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
			<Card>
				...
				<svelte:fragment slot="body">
					<div class="grid items-center grid-cols-2 md:px-4 xl:p-6 md:h-[90%] justify-center">
