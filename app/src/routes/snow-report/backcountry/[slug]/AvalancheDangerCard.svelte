					...
					{#each backcountryDetails.danger_levels as { date, above_treeline, near_treeline, below_treeline }}
						<div id="avy-forecast-container" class="w-full">
							...
							<div class="flex w-full flex-col">
								...
								>
									<p class="min-w-[105px] whitespace-nowrap text-surface-300 text-sm md:text-base">Above Treeline</p>
								...
								>
									<p class="min-w-[105px] whitespace-nowrap text-surface-300 text-sm md:text-base">Near Treeline</p>
									<p class="flex-grow text-center text-sm font-semibold md:text-base">
								...
								>
									<p class="min-w-[105px] whitespace-nowrap text-surface-300 text-sm md:text-base">Below Treeline</p>
									<p class="flex-grow text-center text-sm font-semibold md:text-base">
