...
<svelte:head>
	...
	<meta
		name="description"
		content="Get real-time snow reports, mountain conditions, and accurate weather forecasts for Colorado's premier ski destinations | Stay informed with PowderHound"
	/>
