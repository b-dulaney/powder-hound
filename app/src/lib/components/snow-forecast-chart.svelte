<script lang="ts">
	...
	export let angleXAxis: boolean = false;
							...
							<div class="flex w-full items-center justify-center pt-4 gap-4">
								<span class="inline-flex items-center"><div class="w-4 h-4 bg-primary-500 rounded mx-2" /> Day</span>
								<span class="inline-flex items-center"><div class="w-4 h-4 bg-secondary-500 rounded mx-2" /> Night</span>
							</div>
