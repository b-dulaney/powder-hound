...
<TabGroup class="border-b border-b-surface-500 md:border md:border-surface-500 md:rounded-lg" regionPanel="p-4" regionList="bg-surface-800 border-t border-t-surface-500 md:rounded-t-lg overflow-x-auto" active="!bg-surface-700 border-b-2 border-b-surface-50 !text-surface-50">
	<Tab bind:group={tabSet} name="tab1" class="text-surface-300 font-semibold tracking-tighter bg-surface-900 !rounded-none border-r border-r-surface-500 md:pr-10 min-w-[120px] md:min-w-[160px] text-start" value={0}>
	...
	{#if snowPastWeek !== null}
		<Tab bind:group={tabSet} name="tab2" value={2} class="text-surface-300 font-semibold tracking-tighter bg-surface-900 !rounded-none border-r border-r-surface-500 md:pr-10 min-w-[120px] md:min-w-[160px] text-start">
	...
	<svelte:fragment slot="panel">
		...
		{:else if tabSet === 2 && snowfallHistoricalChartData !== null}
