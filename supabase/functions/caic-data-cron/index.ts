...
const API_URL = "https://looper.avalanche.state.co.us/weather/ptfcst/wrfhr/current"
 ...
 */
async function fetchPointForecasts(mountains: MountainRow[]): Promise<CaicData[]> {
 ...
 */
async function updatePointForecastData(forecastData: CaicData[]): Promise<DbResult<CaicData>> {
