  ...
  userAlerts.forEach(async (user: UserAlert) => {
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: [user.email],
        subject: "PowderHound recent snowfall alert",
        html: `<!doctype html>
                              ...
                              <td style="border:none;vertical-align:top;padding:0px 0px 0px 0px;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                  <tbody>
                                    <tr>
                                      <td align="center" style="background:#fcfcfc;font-size:0px;padding:10px 25px 10px 25px;word-break:break-word;">
                                        <div style="font-family:Open Sans,Roboto,Arial,sans-serif;font-size:30px;font-weight:600;line-height:1.7;text-align:center;color:#1A1C26;">It's a powder day!<br></div>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                              ...
                              <td style="border:none;vertical-align:top;padding:0px 0px 0px 0px;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                  <tbody>
                                    <tr>
                                      <td align="center" style="background:#fcfcfc;font-size:0px;padding:10px 25px 10px 25px;word-break:break-word;">
                                        <div style="font-family:Open Sans,Roboto,Arial,sans-serif;font-size:20px;font-weight:300;line-height:1.7;text-align:center;color:#1A1C26;">A recent snowfall alert has been triggered for one or more of your favorite locations:<br></div>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                                ...
                                <td style="border:none;vertical-align:top;padding:0px 0px 0px 0px;">
                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                    <tbody>
                                      <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px 10px 25px;word-break:break-word;">
                                          <div style="font-family:Open Sans,Roboto,Arial,sans-serif;font-size:18px;line-height:1.7;text-align:center;color:#1A1C26;">Fresh Snow<br></div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
